    ...
    <section className="mb-12">
      ...
      <div className="max-w-2xl">
        ...
        <div
          ...
          style={{ marginLeft: "50%", width: "33.33%" }}
        >
          <p className="mb-1 text-[10px] tracking-wide text-gray-500 uppercase">
            UN80 Changes
          </p>
          <div className="rounded bg-gray-50 text-xs">
            ...
            <div className="flex justify-between border-b border-gray-200 px-2 py-1">
              ...
              <span className="text-gray-900">
                {getArrow(
                  b["UN80 changes (excluding transitional capacities) – Other"],
                )}
                {formatMoney(
                  b["UN80 changes (excluding transitional capacities) – Other"],
                  true,
            ...
            <div className="flex justify-between rounded-b bg-gray-100 px-2 py-1 font-medium">
              <span className="text-gray-900">Total</span>
              <span className="text-gray-900">
                {getArrow(
                  b["UN80 changes (excluding transitional capacities) – Total"],
                )}
                {formatMoney(
                  b["UN80 changes (excluding transitional capacities) – Total"],
                  true,
          ...
          {b["Transitional capacities"] !== null &&
            b["Transitional capacities"] !== 0 && (
              <div className="mt-1 flex justify-between rounded bg-amber-50 px-2 py-1 text-xs">
                <span className="text-amber-700">Transitional Capacities</span>
                <span className="font-medium text-amber-900">
                  {getArrow(b["Transitional capacities"])}
                  {formatMoney(b["Transitional capacities"], true)}
                </span>
              </div>
            )}
        </div>
